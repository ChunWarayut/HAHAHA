...
function handleDisconnect() {
  ...
  connection.on('error', function(err) {
      ...
      if (err.code === 'PROTOCOL_CONNECTION_LOST') { 	// Connection to the MySQL server is usually >>>> if (err.code === 'PROTOCOL_ENQUEUE_AFTER_FATAL_ERROR' || err.code === 'PROTOCOL_CONNECTION_LOST') { 
